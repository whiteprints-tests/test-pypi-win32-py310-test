...
project = "test pypi win32 py310-test"
...
release = metadata.version("test_pypi_win32_py310_test")
...
html_theme_options = {
    "icon_links": [
        {
            "name": "GitHub",
            "url": "https://github.com/whiteprints-tests/test-pypi-win32-py310-test",
            "icon": "fa-brands fa-square-github",
            "type": "fontawesome",
        },
        {
            "name": "PyPI",
            "url": "https://pypi.org/project/test-pypi-win32-py310-test",
